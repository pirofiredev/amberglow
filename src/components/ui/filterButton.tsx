...
export default function FilterButton() {
    return (
        <div className={`filterButton flex flex-row items-center gap-1 border border-(--border) rounded-lg p-1 text-(--muted-foreground) w-25 justify-center`}>
            ...
            <input type="button" value="filter" className={"text-[0.8rem]"}/>
        </div>
    );
}